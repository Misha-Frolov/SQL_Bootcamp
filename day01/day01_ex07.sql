/*
Write an SQL statement that returns the order date 
from the person_order table and the corresponding 
person name who made an order from the person table. 
